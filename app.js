...
const weatherIconMap = {
    ...
    // if (vw <= 480) {
    //     document.getElementById("hid").style.visibility = "none";  
    //     $('.hidd').hide();
    // }else{
    //     $('.hidd').show();
    // }
    ...
    //   var vw = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
    //   var hidElements = document.querySelectorAll('.hid li'); // Get all elements with the class 'hid'

    //   hidElements.forEach(function(element) {
    //     if (vw <= 480 && index >= 2) {
    //       element.style.display = 'none';
    //     } else {
    //       element.style.display = 'block'; // Or 'inline' or 'inline-block', depending on the desired display type
    //     }
    //   });
    // }
